...
var (
	...
	YPARENTORG = starty + grid/2
	YCHILDORG  = YPARENTORG + grid + span
	XPARENTORG = startx + grid/2
	XCHILDORG  = startx + grid/2
)
...
func main() {
	...
	fmt.Println(count, WIDTH, YPARENTORG, YCHILDORG, XPARENTORG)
...
func OneKidSVG(w http.ResponseWriter, req *http.Request) {
	...
	for row.Next() {
		...
		if id.Id == 1 {
			s.Text(startx+(grid/4)*3, YPARENTORG, strconv.Itoa(id.Age), "text-anchor:middle;font-size:30px")
			s.Square(XPARENTORG, starty+grid/4, grid/2, "fill:none;stroke:black")
		} else if id.Id == 2 {
			s.Text(startx+(grid/4)*5+span, YPARENTORG, strconv.Itoa(id.Age), "text-anchor:middle;font-size:30px")
...
func TwoKidSVG(w http.ResponseWriter, req *http.Request) {
	...
	for row.Next() {
		...
		if id.Id == 1 {
			...
			s.Text((grid/4)*3, YCHILDORG, strconv.Itoa(id.Age), "text-anchor:middle;font-size:30px")
			if id.Gender == "男" {
			...
			s.Text(startx+grid+span+grid/4, YCHILDORG, strconv.Itoa(id.Age), "text-anchor:middle;font-size:30px")
			if id.Gender == "男" {
...
func ThreeKidSVG(w http.ResponseWriter, req *http.Request) {
	...
	s.Line(XCHILDORG+grid/4, YPARENTORG, XCHILDORG+(children-1)*(span+grid)-grid/4, YPARENTORG, "stroke:black;stroke-width:20;stroke-linecap:butt")
	s.Line(XPARENTORG, YPARENTORG+grid/2, XPARENTORG+(children-1)*(span+grid), YPARENTORG+grid/2, "stroke:black;stroke-width:20;stroke-linecap:butt")

	s.Line(XPARENTORG, YPARENTORG+grid/2, XPARENTORG, YCHILDORG-grid/4, "stroke:black;stroke-width:20;stroke-linecap:butt")
	s.Line(XPARENTORG+(span+grid), YPARENTORG, XPARENTORG+(span+grid), YCHILDORG-grid/4, "stroke:black;stroke-width:20;stroke-linecap:butt")
	s.Line(XPARENTORG+(children-1)*(span+grid), YPARENTORG+grid/2, XPARENTORG+(children-1)*(span+grid), YCHILDORG-grid/4, "stroke:black;stroke-width:20;stroke-linecap:butt")
	...
	for row.Next() {
		...
		if id.Id == 1 {
			s.Text(XPARENTORG, YPARENTORG, strconv.Itoa(id.Age), "text-anchor:middle;font-size:30px")
			s.Square(XPARENTORG-grid/4, YPARENTORG-grid/4, grid/2, "fill:none;stroke:black")
		} else if id.Id == 2 {
			s.Text(XPARENTORG+(children-1)*(span+grid), YPARENTORG, strconv.Itoa(id.Age), "text-anchor:middle;font-size:30px")
			s.Circle(XPARENTORG+(children-1)*(span+grid), YPARENTORG, grid/4, "fill:none;stroke:black")
		} else if id.Id == 3 {
			s.Text(XCHILDORG, YCHILDORG, strconv.Itoa(id.Age), "text-anchor:middle;font-size:30px")
			if id.Gender == "男" {
				s.Square(XCHILDORG-grid/4, YCHILDORG-grid/4, grid/2, "fill:none;stroke:black")
			} else {
				s.Circle(XCHILDORG, YCHILDORG, grid/4, "fill:none;stroke:black")
			}
		} else if id.Id == 4 {
			s.Text(XCHILDORG+(span+grid), YCHILDORG, strconv.Itoa(id.Age), "text-anchor:middle;font-size:30px")
			if id.Gender == "男" {
				s.Square(XCHILDORG+(span+grid)-grid/4, YCHILDORG-grid/4, grid/2, "fill:none;stroke:black")
			} else {
				s.Circle(XCHILDORG+(span+grid), YCHILDORG, grid/4, "fill:none;stroke:black")
			}

		} else if id.Id == 5 {
			s.Text(XCHILDORG+2*(span+grid), YCHILDORG, strconv.Itoa(id.Age), "text-anchor:middle;font-size:30px")
			if id.Gender == "男" {
				s.Square(XCHILDORG+2*(span+grid)-grid/4, YCHILDORG-grid/4, grid/2, "fill:none;stroke:black")
			} else {
				s.Circle(XCHILDORG+2*(span+grid), YCHILDORG, grid/4, "fill:none;stroke:black")
			}
		}
	}
	s.End()
